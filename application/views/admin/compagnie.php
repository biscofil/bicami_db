        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label for="id_paese" class="col-sm-2 control-label">NAZIONALITA:</label>
                        <div class="col-sm-10">
                            <select class="form-control select2-input" id="id_paese" name="id_paese" style="width: 100%" required></select>
                        </div>
                    </div>
                </form>
            </div>

...
<html lang="en">
    <head>
        ...
        <script>
            ...
            var __xhr_controller = "xhr";
        </script>

        <link href="<?= base_url('public/select2/css/select2.css') ?>" rel="stylesheet">
        <link href="<?= base_url('public/select2/css/select2-bootstrap.css') ?>" rel="stylesheet">
    ...
    <body>
        ...
        <header id="top" class="header">
            <div class="text-vertical-center">
                <h1><span class="label label-success">BiCaMi</span></h1>
                <h3>Progetto Basi di Dati 2016 - 2017</h3>
                <br>
                        ...
                        <div class="row">
                            <div class="col-md-3 col-sm-6">
                                <div class="service-item">
                                    ...
                                    <h4>
                                        <strong>Cerca un particolare volo</strong>
                                    </h4>
                                    <p>Ottieni informazioni in tempo reale sul volo.</p>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="portfolio-item">
                                    <a href="#">
                                        <img class="img-portfolio img-responsive" src="<?= base_url('public/img/portfolio-1.jpg') ?>">
                                    </a>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="portfolio-item">
                                    <a href="#">
                                        <img class="img-portfolio img-responsive" src="<?= base_url('public/img/portfolio-2.jpg') ?>">
                                    </a>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="portfolio-item">
                                    <a href="#">
                                        <img class="img-portfolio img-responsive" src="<?= base_url('public/img/portfolio-3.jpg') ?>">
                                    </a>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="portfolio-item">
                                    <a href="#">
                                        <img class="img-portfolio img-responsive" src="<?= base_url('public/img/portfolio-4.jpg') ?>">
                                    </a>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 text-center">
                    ...
                    <p>-</p>
                    <ul class="list-unstyled">
                        <li><i class="fa fa-envelope-o fa-fw"></i> <a href="mailto:@stud.unive.it">@stud.unive.it</a>
                        </li>
                    </ul>
                    <br>
                    <ul class="list-inline">
                ...
                <div class="col-lg-4 text-center">
                    ...
                    <p>-</p>
                    <ul class="list-unstyled">
                        <li><i class="fa fa-envelope-o fa-fw"></i> <a href="mailto:@stud.unive.it">852144@stud.unive.it</a>
                        </li>
                    </ul>
                    <br>
                    <ul class="list-inline">
    ...
    <script src="<?= base_url('public/select2/js/select2.js') ?>"></script>

...
-- Started on 2016-12-19 23:27:03
...
--
-- TOC entry 2241 (class 1262 OID 1404784)
...
--
-- TOC entry 194 (class 1259 OID 1972888)
...
--
-- TOC entry 195 (class 1259 OID 1972892)
...
--
-- TOC entry 207 (class 1259 OID 1980358)
...
--
-- TOC entry 205 (class 1259 OID 1980348)
...
--
-- TOC entry 201 (class 1259 OID 1980143)
...
--
-- TOC entry 198 (class 1259 OID 1980103)
...
--
-- TOC entry 193 (class 1259 OID 1972870)
...
--
-- TOC entry 200 (class 1259 OID 1980135)
...
--
-- TOC entry 191 (class 1259 OID 1972852)
...
--
-- TOC entry 206 (class 1259 OID 1980352)
...
--
-- TOC entry 199 (class 1259 OID 1980109)
...
--
-- TOC entry 188 (class 1259 OID 1972701)
...
--
-- TOC entry 202 (class 1259 OID 1980327)
...
--
-- TOC entry 190 (class 1259 OID 1972848)
...
--
-- TOC entry 203 (class 1259 OID 1980332)
...
--
-- TOC entry 204 (class 1259 OID 1980336)
...
--
-- TOC entry 189 (class 1259 OID 1972707)
...
--
-- TOC entry 208 (class 1259 OID 1980362)
...
--
-- TOC entry 197 (class 1259 OID 1973579)
...
--
-- TOC entry 209 (class 1259 OID 1980367)
...
--
-- TOC entry 196 (class 1259 OID 1973563)
...
--
-- TOC entry 192 (class 1259 OID 1972866)
...
-- Dependencies: 177
-- Name: aeroplani_id_seq; Type: SEQUENCE SET; Schema: public; Owner: a2015u54
--

SELECT pg_catalog.setval('aeroplani_id_seq', 7, true);


--
-- TOC entry 2229 (class 0 OID 1972539)
-- Dependencies: 179
-- Data for Name: aeroporti; Type: TABLE DATA; Schema: public; Owner: a2015u54
--

COPY aeroporti (sigla, nome, id_citta) FROM stdin;
PEG	Adamo Giulietti	1487
FLR	Amerigo Vespucci	1471
CTA	Fontanarossa	1472
BLQ	G.Marconi	1470
FOG	Gino Lisa	1488
PMF	Giuseppe Verdi	1484
VCE	Marco Polo	1474
BDS	O. Perozzi	1514
BRI	Palese Macchie	1473
PSR	Pasquale Liberi	1498
VEN	Magellano	634
TRE	Ciampino	123
NAP	Ugo Niutta	1466
TSF	Giannino Ancilotto	4080
QEV	awdawdaw	36
BZO	Bolzano	1508
PSA	Galileo Galilei	1516
DWA	awdawdawd	175
QRT	qwrqwrfq	1462
JYG	aawdaw	249
REG	Stretto	1481
JYK	aawdaw	249
GOA	Cristoforo Colombo	1469
MAR	Marcopolo	1474
UOI	fiumicino	1464
TRU	Trudy	1033
TES	Tessera	1474
...
ABC	Demo	1466
TTT	Giavelli	47
BCN	Barcelona El Prat	654
\.


--
-- TOC entry 2222 (class 0 OID 1404788)
-- Dependencies: 171
-- Data for Name: city; Type: TABLE DATA; Schema: public; Owner: a2015u54
--
...
--
-- TOC entry 2234 (class 0 OID 1972655)
-- Dependencies: 184
-- Data for Name: compagnie; Type: TABLE DATA; Schema: public; Owner: a2015u54
--

COPY compagnie (id, nome, nazionalita) FROM stdin;
1	Alitalia	ITA
2	Emirates	ITA
4	Delta	ITA
3	Luftansa	DEU
...
-- Dependencies: 183
-- Name: compagnie_id_seq; Type: SEQUENCE SET; Schema: public; Owner: a2015u54
--

SELECT pg_catalog.setval('compagnie_id_seq', 10, true);


--
-- TOC entry 2223 (class 0 OID 1404794)
-- Dependencies: 172
-- Data for Name: country; Type: TABLE DATA; Schema: public; Owner: a2015u54
--
...
--
-- TOC entry 2224 (class 0 OID 1404801)
-- Dependencies: 173
-- Data for Name: countrylanguage; Type: TABLE DATA; Schema: public; Owner: a2015u54
--
...
--
-- TOC entry 2231 (class 0 OID 1972546)
-- Dependencies: 181
-- Data for Name: prenotazioni; Type: TABLE DATA; Schema: public; Owner: a2015u54
--

COPY prenotazioni (id, data_prenotazione, num_posti_prenotati, id_utente, id_volo_pianificato, classe) FROM stdin;
20	2016-10-04	4	2	6	business
21	2016-10-04	4	2	6	business
22	2016-10-04	4	2	6	business
24	2016-10-04	4	2	6	economy
25	2016-10-04	4	2	6	economy
26	2016-10-04	4	2	6	business
28	2016-10-10	2	2	10	business
29	2016-10-10	2	2	7	business
30	2016-10-10	2	2	7	business
13	2016-10-04	10	1	20	business
17	2016-10-04	5	2	11	business
14	2016-10-04	5	2	21	economy
\.
...
-- Dependencies: 180
-- Name: prenotazioni_id_seq; Type: SEQUENCE SET; Schema: public; Owner: a2015u54
--

SELECT pg_catalog.setval('prenotazioni_id_seq', 51, true);


--
-- TOC entry 2228 (class 0 OID 1972533)
-- Dependencies: 178
-- Data for Name: tipi_aeroplani; Type: TABLE DATA; Schema: public; Owner: a2015u54
--

COPY tipi_aeroplani (id, nome, posti_economy, posti_business) FROM stdin;
4	747	12	24
5	Cesna	80	50
7	demo	10	10
2	Airbus	23	24
...
--
-- TOC entry 2226 (class 0 OID 1972502)
-- Dependencies: 176
-- Data for Name: utenti; Type: TABLE DATA; Schema: public; Owner: a2015u54
--

COPY utenti (id, nome, cognome, indirizzo, telefono, carta_credito, username, passwd, user_level) FROM stdin;
2	marco	cabianca	via yyy 2	123456789	123456789	cabiamar	55c3b5386c486feb662a0785f340938f518d547f	1
3	francesco	milanese	via zzz 7	12345678	123456789	milanfra	55c3b5386c486feb662a0785f340938f518d547f	1
14	utente_demo	utente	968688	83329	69889698	demo	55c3b5386c486feb662a0785f340938f518d547f	0
1	filippo	bisconcin	via xxx 1	123456789	1234567890	biscofil	55c3b5386c486feb662a0785f340938f518d547f	1
\.
...
-- Dependencies: 175
-- Name: utenti_id_seq; Type: SEQUENCE SET; Schema: public; Owner: a2015u54
--

SELECT pg_catalog.setval('utenti_id_seq', 16, true);


--
-- TOC entry 2232 (class 0 OID 1972568)
-- Dependencies: 182
-- Data for Name: voli; Type: TABLE DATA; Schema: public; Owner: a2015u54
--

COPY voli (codice, cod_compagnia, aeroporto_partenza, durata_volo, prezzo_business, prezzo_economy, tipo_aeroplano, aeroporto_arrivo) FROM stdin;
PLA2	1	TRE	3520	400	234	1	MAR
PLA1	1	MAR	120	10	5	1	TRE
PLA4	1	MAR	101	100	80	1	VEN
PLA7	1	VEN	10	10	5	1	MAR
PLA9	1	ABC	3	100	70	5	TES
PLA11	1	VCE	200	100	200	2	TRE
PLA10	6	TES	3003	50	20	4	ASD
\.


--
-- TOC entry 2236 (class 0 OID 1972679)
-- Dependencies: 187
-- Data for Name: voli_pianificati; Type: TABLE DATA; Schema: public; Owner: a2015u54
--

COPY voli_pianificati (id, gate, ritardo, codice_volo, data_ora, cancellato) FROM stdin;
11	2	0	PLA2	2016-10-31 18:00:00	0
18	7	18	PLA2	2016-11-08 12:42:00	0
19	4	29	PLA4	2016-11-08 12:53:00	0
20	6	24	PLA2	2016-11-08 12:45:00	0
21	8	13	PLA1	2016-11-08 13:25:00	0
22	3	41	PLA2	2016-11-08 13:15:00	1
23	3	7	PLA2	2016-11-08 13:23:00	1
24	7	10	PLA4	2016-11-08 13:30:00	1
25	3	51	PLA2	2016-11-08 13:20:00	1
26	5	38	PLA4	2016-11-08 13:16:00	1
27	10	33	PLA2	2016-11-08 13:15:00	0
28	7	0	PLA4	2016-11-08 13:23:00	1
29	5	49	PLA4	2016-11-08 13:19:00	0
30	2	0	PLA4	2016-11-08 13:28:00	0
32	4	0	PLA4	2016-11-23 00:00:00	0
33	10	25	PLA1	2016-11-08 15:18:00	1
35	2	53	PLA2	2016-11-08 15:08:00	1
36	7	8	PLA2	2016-11-08 15:21:00	1
37	3	19	PLA4	2016-11-08 15:07:00	0
38	10	50	PLA2	2016-11-08 15:12:00	0
39	2	26	PLA2	2016-11-08 15:23:00	0
40	2	0	PLA2	2016-11-16 17:00:00	0
41	1	0	PLA9	2016-11-13 00:00:00	0
86	6	23	PLA10	2016-12-19 23:12:28	0
4	1	2000	PLA2	2016-11-16 00:00:00	0
5	1	2	PLA2	2016-11-30 00:00:00	0
6	1	0	PLA2	2016-11-30 00:00:00	0
8	5	0	PLA2	2016-11-15 00:00:00	0
10	3	5	PLA2	2016-11-30 00:00:00	0
3	1	50	PLA1	2016-11-23 00:00:00	1
45	6	7	PLA7	2016-11-10 20:22:02	0
46	9	26	PLA9	2016-11-11 23:22:03	0
47	1	44	PLA2	2016-11-12 03:22:03	0
48	6	56	PLA2	2016-11-10 18:22:03	1
49	3	43	PLA9	2016-11-11 12:12:21	0
50	4	56	PLA9	2016-11-10 12:12:21	0
51	4	8	PLA1	2016-11-11 12:12:21	0
52	2	29	PLA1	2016-11-11 21:51:27	0
7	2	20	PLA1	2016-11-25 00:00:00	0
63	7	8	PLA4	2016-11-11 19:14:38	1
34	3	46	PLA2	2016-11-30 18:00:00	0
64	2	12	PLA9	2016-11-23 19:00:00	0
61	12	0	PLA10	2017-01-19 06:00:00	0
67	5	58	PLA4	2016-11-20 11:35:55	0
68	10	23	PLA7	2016-11-19 20:35:55	0
69	4	57	PLA1	2016-11-20 23:35:55	0
70	2	12	PLA10	2016-11-21 12:35:55	1
71	2	36	PLA9	2016-11-19 17:35:57	0
72	10	30	PLA1	2016-11-19 19:35:57	0
73	5	37	PLA2	2016-11-21 01:35:57	0
74	7	37	PLA1	2016-11-18 21:35:58	1
75	8	7	PLA10	2016-11-20 11:35:58	0
76	4	22	PLA2	2016-11-20 20:35:58	0
2	2	1002	PLA1	2016-11-25 00:00:00	1
77	3	59	PLA11	2016-12-20 10:06:04	1
78	9	34	PLA10	2016-12-21 04:06:04	0
79	8	44	PLA4	2016-12-21 17:06:04	1
80	8	31	PLA10	2016-12-20 11:12:26	0
81	3	18	PLA9	2016-12-21 10:12:26	0
82	4	53	PLA9	2016-12-21 20:12:26	0
83	2	5	PLA2	2016-12-22 10:12:27	0
84	10	47	PLA1	2016-12-21 02:12:28	0
85	5	8	PLA11	2016-12-22 00:12:28	0
\.
...
-- Dependencies: 186
-- Name: voli_pianificati_id_seq; Type: SEQUENCE SET; Schema: public; Owner: a2015u54
--

SELECT pg_catalog.setval('voli_pianificati_id_seq', 86, true);
...
--
-- TOC entry 2216 (class 2618 OID 1980339)
...
-- Completed on 2016-12-19 23:27:20
